...
# ONELINER Download/Install: sudo wget https://github.com/rachelproject/rachelplus/blop/master/cap-ka-lite-install.sh -O /root/cap-ka-lite-install.sh; bash cap-ka-lite-install.sh
