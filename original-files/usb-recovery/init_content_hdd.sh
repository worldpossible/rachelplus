...
create_disk_image() {
    ...
    # Part1: 400G for preloaded content
    echo "@@ Create preloaded content partition."
    sgdisk -n 1:2048:765460479 -c 1:"preloaded" -u 1:77777777-7777-7777-7777-777777777777 -t 1:8300 $1

    # Part2: Remaining 100G for teacher content
    echo "@@ Create teacher partition."
    sgdisk -n 2:765460480:-1M -c 2:"uploaded" -u 2:88888888-8888-8888-8888-888888888888 -t 2:8300 $1
